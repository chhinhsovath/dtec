  📊 DGTech Platform - User Roles & Content Creation 
  Analysis

  ---
  🎯 Total User Roles: 11 (Hierarchical Structure)
  ...
  ---
  📋 Content Creator Responsibilities by Role
  ...
  ---
  📊 Database Schema Overview (Content Creation Related)

  Teachers Create:
  ├── courses (with title, description, schedule)
  ├── course_materials (lectures, videos, readings)
  ...
  └── grades (scores, feedback, letter grades)

  Parents View:
  ├── student_progress (GPA, attendance)
  ├── grades (student performance)
  ├── attendance_records
  └── assignments (due dates)

  ---
  🔐 Role-Based Permissions (from RLS Policies)
  ...
  | View own grades       | ✅       | ❌             | ❌
     | ✅ (with permission) |
  | View student progress | ❌       | ✅ (own class) | ✅
     | ✅ (own child)       |
